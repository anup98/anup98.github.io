...
window.onload = function () {
  ...
  star1 = new Path.Star({
	...
	text1.position = star1.bounds.center;
	text2.position = star2.bounds.center;
	text3.position = star3.bounds.center;
	text4.position = star4.bounds.center;
	text5.position = star5.bounds.center;
	text6.position = star6.bounds.center;
